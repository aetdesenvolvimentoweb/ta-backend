...
const DEFAULT_STEMS = [
  'caralh', 'porra', 'merda', 'foda', 'fude', 'puta', 'putar',
  'cuzao', 'bunda', 'piranha', 'vagabund',
  'fdp', 'arrombad', 'corno', 'viad', 'bicha',
  'desgracad', 'imbecil', 'idiota',
  'otario', 'babaca', 'cretino', 'escrot', 'puto'
];
